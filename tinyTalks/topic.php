...
<div id="sendbutton" >
			...
			<div id="tweettable">
                                <div id="tweettitle">
                                        <p id = "tweettitletext">Hot Topics</p>
                                </div><!-- tweettitle-->
                                <div id="tweetmiddle">
					<?php
$query ="SELECT Topic.content AS content, Topic.topicid AS topicid, H.topicnum AS topicnum FROM Topic,(SELECT topicid, COUNT(*) AS topicnum FROM hasTopic GROUP BY topicid) H WHERE Topic.topicid = H.topicid ORDER BY topicnum DESC";
$result = mysqli_query($dbcon, $query)
  or die('User not found: ' . mysqli_error());
					...
					<?php
						...
						print "<a href = \"tweettopic.php?tweettopicid=";
						print $tuple['topicid'];
						print "&page=1\">";
					...
					?>
                                ...
                                <div id="tweettile" >
					<p id="previous"><a href="topic.php?type=1&page=<?php echo $prepage?>">Previous</a>&nbsp<a href="topic.php?type=1&page=<?php echo $nextpage?>"> 	Next</a></p>
                                </div><!-- tweettile-->
