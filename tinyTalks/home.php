...
<div id="sendbutton" >
			...
			<div id="tweettable">
                                <div id="tweettitle">
                                        <p id = "tweettitletext">tinyTalks</p>
                                </div><!-- tweettitle-->
                                <div id="tweetmiddle">
					<?php
$query ="SELECT tweetid,Users.name AS name, Tweet.timeStamp AS timeStamp, Tweet.content AS content FROM follow, Tweet, Users WHERE follow.follower = '$user' AND follow.username = Tweet.fromUser AND follow.username = Users.username ORDER BY timeStamp DESC";
$result = mysqli_query($dbcon, $query)
  or die('User not found: ' . mysqli_error());
					...
					?>
                                ...
                                <div id="tweettile" >
					<p id="previous"><a href="home.php?showpage=<?php echo $prepage?>">Previous</a>&nbsp<a href="home.php?showpage=<?php echo $nextpage?>"> 	Next</a></p>
                                </div><!-- tweettile-->
